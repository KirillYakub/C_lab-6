...
void medium_1()
{
	...
	ofstream input("C:\\Users\\KIRILL\\source\\repos\\С++ практика\\Второй семестр\\Лабораторные\\Lab 6\\medium1_bin_File.bin", ios::binary | ios::out);
	...
	f_out = fopen("C:\\Users\\KIRILL\\source\\repos\\С++ практика\\Второй семестр\\Лабораторные\\Lab 6\\medium1_bin_file.bin", "wb");
...
void medium_2()
{
	...
	f_out = fopen("C:\\Users\\KIRILL\\source\\repos\\С++ практика\\Второй семестр\\Лабораторные\\Lab 6\\medium2_numbers_before.bin", "wb");
	...
	f_in = fopen("C:\\Users\\KIRILL\\source\\repos\\С++ практика\\Второй семестр\\Лабораторные\\Lab 6\\medium2_numbers_before.bin", "rb");
	...
	f_out = fopen("C:\\Users\\KIRILL\\source\\repos\\С++ практика\\Второй семестр\\Лабораторные\\Lab 6\\medium2_numbers_after.bin", "wb");
	fwrite(new_arr, sizeof(double), quantity, f_out);
	fclose(f_out);

	cout << endl << endl << "Цифры после изменения: ";

	f_in = fopen("C:\\Users\\KIRILL\\source\\repos\\С++ практика\\Второй семестр\\Лабораторные\\Lab 6\\medium2_numbers_after.bin", "rb");
	fread(new_arr, sizeof(double), quantity, f_in);
	fclose(f_in);
...
void medium_3()
{
	...
	//после записи открываем файл и считываем данные в новый массив;
	f_out = fopen("C:\\Users\\KIRILL\\source\\repos\\С++ практика\\Второй семестр\\Лабораторные\\Lab 6\\medium3_cars_before.bin", "wb");
	fwrite(arr, sizeof(car), size, f_out);
	fclose(f_out);

	car* new_arr = new car[size];

	f_in = fopen("C:\\Users\\KIRILL\\source\\repos\\С++ практика\\Второй семестр\\Лабораторные\\Lab 6\\medium3_cars_before.bin", "rb");
	...
	f_out = fopen("C:\\Users\\KIRILL\\source\\repos\\С++ практика\\Второй семестр\\Лабораторные\\Lab 6\\medium3_cars_after.bin", "wb");
	fwrite(new_arr, sizeof(car), size, f_out);
	fclose(f_out);

	f_in = fopen("C:\\Users\\KIRILL\\source\\repos\\С++ практика\\Второй семестр\\Лабораторные\\Lab 6\\medium3_cars_after.bin", "rb");
	fread(new_arr, sizeof(car), size, f_in);
	fclose(f_in);
